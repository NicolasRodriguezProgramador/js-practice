...
export default function userDeviceInfo(id){
    ...
    if( isBrowser.opera() ){
        $id.innerHTML += '<p><mark>Este contenido sólo se ve en Opera.</mark></p>'
    }
    if( isBrowser.ie() ){
        $id.innerHTML += '<p><mark>Este contenido sólo se ve en Internet Explorer.</mark></p>'
    }
    if( isBrowser.edge() ){
        $id.innerHTML += '<p><mark>Este contenido sólo se ve en Edge.</mark></p>'
    }

    /********************* Fin Contenido Exclusivo *********************/
